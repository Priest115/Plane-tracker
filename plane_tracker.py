...
WARBIRD_WATCHLIST = [
    ...
    {"reg": "G-BMSB", "name": "MJ627",               "desc": "Spitfire T.9 two-seat (ex-Irish AC) - Biggin Hill; damaged May 2025"},
    ...
    # {"hex": "??????", "name": "BBMF Spitfire Vb",  "desc": "Spitfire Vb AB910 - back flying Jan 2026"},
]
...
MIN_ALT_FT    = 500
MAX_POSITIONS = 100  # position samples kept per aircraft per day
...
def check_warbids(state):
    for bird in WARBIRD_WATCHLIST:
        ...
        # Log position on every poll while airborne
